...
public class Orchestrator implements Mode {

    private final static Mode INSTANCE = new Orchestrator();

    static class DamageStrategy implements Strategy {
        @Override
    ...
    static class EvasiveStrategy implements Strategy {
        @Override
        public void run(JuniorRobot r) {
            ...
            r.back(100);
            r.turnGunLeft(360);
            this.changeSenseZigZag(r);
        }

        private void changeSenseZigZag(JuniorRobot r) {
            r.ahead(75);
    ...
    public Strategy checkMode(JuniorRobot r) {
        return (r.others < 9) ? new DamageStrategy() : new EvasiveStrategy();
    }
}
